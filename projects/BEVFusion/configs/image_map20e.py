...
input_modality = dict(use_lidar=False, use_camera=True, use_map=True)
...
model = dict(
    ...
    fusion_layer=dict(
        type='ConvFuser', in_channels=[80,64], out_channels=512),
...
train_pipeline = [
    ...
    dict(
        ...
        keys=[
            'points', 'img', 'gt_bboxes_3d', 'gt_labels_3d', 'gt_bboxes','map_mask',
            'gt_labels'
        ],
        meta_keys=[
